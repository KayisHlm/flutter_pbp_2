  ...
  Future<void> loadData() async {
    try {
      ...
      setState(() {
        ...
        final debtorEmailsWithHistory = loadedHutangs
            .map((h) => h.debtor.email)
            .where((e) => e != null)
            .cast<String>()
            .toSet();
        users = loadedUsers
            .where((u) => myId == null ? true : u.id != myId)
            .where((u) => debtorEmailsWithHistory.contains(u.email))
            .toList();
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const AddHutangScreen()),
