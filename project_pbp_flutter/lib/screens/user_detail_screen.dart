                          ...
                          child: InkWell(
                            onTap: () async {
                              final result = await Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      HutangDetailScreen(hutang: hutang),
                                ),
                              );
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: TextStyle(
                                              fontSize: 14,
                                              color: hutang.remainingAmount > 0
                                                  ? Colors.red
                                                  : cs.tertiary,
                                              fontWeight: FontWeight.bold,
                                            ),
                                  ...
                                  if (hutang.notes != null &&
                                      hutang.notes!.isNotEmpty) ...[
                                    const SizedBox(height: 8),
                                    Text(
                                      hutang.notes!,
                                      style: TextStyle(
